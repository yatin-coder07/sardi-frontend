          ...
          {loadingOrders ? (
            ...
            <div className="space-y-6">
              {orders.map((order) => (
                <div
                  key={order.id}
                  className="bg-white p-5 md:p-8 rounded-3xl shadow-md border border-gray-100 hover:shadow-lg transition"
                >
                  {/* TOP SECTION */}
                  <div className="flex flex-col md:flex-row justify-between gap-6 border-b pb-4">
                    ...
                    <div className="space-y-2 text-sm md:text-base w-full">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2">
                        ...
                        {order.secondary_address && (
                          <p className="sm:col-span-2">
                            <span className="font-semibold">Secondary:</span> {order.secondary_address}
                          </p>
                        )}
                  ...
                  <div className="mt-4 space-y-2">
                    {order.items.map((item) => (
                      <div
                        key={item.id}
                        className="flex gap-3 items-center bg-gray-50 p-2 rounded-xl"
                      >
                        <img
